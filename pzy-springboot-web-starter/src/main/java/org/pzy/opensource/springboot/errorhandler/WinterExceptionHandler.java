...
import org.pzy.opensource.domain.enums.GlobalSystemErrorCode;
...
public class WinterExceptionHandler {
    ...
    public ResultT<Integer> handle(HttpServletRequest req, HttpServletResponse response, MaxUploadSizeExceededException e) throws IOException {
        ...
        String uri = recordLog(req, e, expMsg, false);
        ResultT<Integer> result = ResultT.error(GlobalSystemErrorCode.FILE_TOO_LARGE.getErrorCode(), GlobalSystemErrorCode.FILE_TOO_LARGE.getDefaultErrorMsg(), uri);
        return result;
    }
    ...
    public ResultT<Integer> handle(HttpServletRequest req, HttpServletResponse response, HttpMediaTypeNotAcceptableException e) throws IOException {
        ...
        String uri = recordLog(req, e, expMsg, false);
        ResultT<Integer> result = ResultT.error(GlobalSystemErrorCode.ACCEPT_TYPE_NOT_SUPPORT.getErrorCode(), GlobalSystemErrorCode.ACCEPT_TYPE_NOT_SUPPORT.getDefaultErrorMsg(), uri);
        return result;
    }
    ...
    public ResultT<Integer> handle(HttpServletRequest req, HttpServletResponse response, MethodArgumentTypeMismatchException e) throws IOException {
        ...
        String uri = recordLog(req, e, expMsg, false);
        ResultT<Integer> result = ResultT.error(GlobalSystemErrorCode.REQUEST_PARAM_MISMATCH.getErrorCode(), "实际请求参数[" + e.getName() + "]不符合预期!", uri);
        return result;
    }
    ...
    private ResultT<Integer> multiParamValidateExp(HttpServletRequest req, HttpServletResponse response, String uri, Set<ConstraintViolation<?>> constraintViolationSet) throws IOException {
        ...
        ResultT<Integer> result = ResultT.error(GlobalSystemErrorCode.PARAM_VALIDATE_EXCEPTION.getErrorCode(), fieldErrors, uri);
        return result;
    }
    ...
    public ResultT<Integer> handle(HttpServletRequest req, HttpServletResponse response, HttpMessageNotReadableException e) throws IOException {
        ...
        String uri = recordLog(req, e, expMsg, false);
        ResultT<Integer> result = ResultT.error(GlobalSystemErrorCode.REQUEST_MESSAGE_EXTRACT.getErrorCode(), expMsg, uri);
        return result;
    }
    ...
    public ResultT<Integer> handle(HttpServletRequest req, HttpServletResponse response, HttpRequestMethodNotSupportedException e) throws IOException {
        ...
        String uri = recordLog(req, e, expMsg, false);
        ResultT<Integer> result = ResultT.error(GlobalSystemErrorCode.REQUEST_METHOD_NOT_SUPPORT.getErrorCode(), expMsg, uri);
        return result;
    }
    ...
    public ResultT<Integer> handle(HttpServletRequest req, HttpServletResponse response, HttpMediaTypeNotSupportedException e) throws IOException {
        ...
        String uri = recordLog(req, e, expMsg, false);
        ResultT<Integer> result = ResultT.error(GlobalSystemErrorCode.CONTENT_TYPE_NOT_SUPPORT.getErrorCode(), "不支持的contentType类型值:" + e.getContentType(), uri);
        return result;
    }
    ...
    public ResultT<Integer> handle(HttpServletRequest req, HttpServletResponse response, MissingServletRequestParameterException e) throws IOException {
        ...
        String uri = recordLog(req, e, expMsg, false);
        ResultT<Integer> result = ResultT.error(GlobalSystemErrorCode.REQUEST_PARAM_NOT_FOUND.getErrorCode(), expMsg, uri);
        return result;
    }
    ...
    public ResultT<Integer> handle(HttpServletRequest req, HttpServletResponse response, BadSqlGrammarException e) throws IOException {
        ...
        ResultT<Integer> result = ResultT.error(GlobalSystemErrorCode.SERVER_EXCEPTION.getErrorCode(), GlobalSystemErrorCode.SERVER_EXCEPTION.getDefaultErrorMsg(), uri);
        return result;
    }
    ...
    private ResultT<Integer> handlerDataRepeatException(HttpServletRequest req, Exception e) {
        ...
        String uri = recordLog(req, e, expMsg, true);
        ResultT<Integer> result = ResultT.error(GlobalSystemErrorCode.DATA_REPEAT.getErrorCode(), GlobalSystemErrorCode.DATA_REPEAT.getDefaultErrorMsg(), uri);
        return result;
    }
    ...
    public ResultT<Integer> handle(HttpServletRequest req, HttpServletResponse response, AuthenticationException e) throws IOException {
        ...
        String uri = recordLog(req, e, expMsg, true);
        ResultT<Integer> result = ResultT.error(GlobalSystemErrorCode.SHIRO_LOGIN_EXCEPTION.getErrorCode(), e.getMessage(), uri);
        return result;
    }
    ...
    public ResultT<Integer> handle(HttpServletRequest req, HttpServletResponse response, IncorrectCredentialsException e) throws IOException {
        ...
        String uri = recordLog(req, e, expMsg, true);
        ResultT<Integer> result = ResultT.error(GlobalSystemErrorCode.SHIRO_LOGIN_EXCEPTION.getErrorCode(), "账号或密码错误!", uri);
        return result;
    }
    ...
    public ResultT<Integer> handle(HttpServletRequest req, HttpServletResponse response, UnauthorizedException e) throws IOException {
        ...
        String uri = recordLog(req, e, expMsg, true);
        ResultT<Integer> result = ResultT.error(GlobalSystemErrorCode.SHIRO_FORBIDDEN_EXCEPTION.getErrorCode(), e.getMessage(), uri);
        return result;
    }
